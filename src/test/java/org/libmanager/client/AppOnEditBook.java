...
public class AppOnEditBook extends App{
    ...
    public void showAddItem() {
        try {
            ...
            controller.initializeEditBook(TestData.getBook());
            dialogStage.setTitle(I18n.getBundle().getString("label.editing.title") + TestData.getBook().getTitle());
